...
$msg_ar="تمت عملية الإضافة بنجاح";
}else {
$erro_msg_en="Sorry , your data is incorrect";
$msg_en="ُEvent added succesfully";
}
...
// 	 echo('1');
	 ...
	 insertInEvent($sql,$conn,$username,$event);
	 /*echo('<script>javascript:history.back(-1);</script>');*/
	echo('<script>window.location = "http://localhost/hadath/event.html?'.$lang.','.$event.',1"</script>');
}else{
	if($lang=='ar'){
